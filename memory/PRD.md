...
- Rebrand to Sitera / sitera.in (2026-06, SELF-TESTED via screenshots): AI-generated S+crane logo (blue/amber, transparent) at /frontend/public/sitera-logo.png + logo192.png + favicon.ico; sidebar (Layout.jsx) & login (LoginPage.jsx) show logo + SITERA wordmark + sitera.in; index.html title "Sitera | Construction Portal" + meta + favicon links; all PDF/Excel export headers & filenames BUILDCORE->SITERA (exports.py); invoice print/share footer -> "Generated by Sitera Construction Portal · sitera.in". NOT changed: seed emails @buildcore.com (credentials), localStorage theme key, old workflow-guide PDFs in /public.
