      ...
      <DialogContent className="bg-zinc-900 border-zinc-700 rounded-none max-w-md" data-testid="employee-form-modal">
        ...
        <form onSubmit={submit} className="space-y-4">
              ...
              <Select value={form.category_id} onValueChange={onCategorySelect}>
                ...
                <SelectContent className="bg-zinc-900 border-zinc-700">
                  ...
                  <SelectItem value="__new" data-testid="add-category-option">
                    <span className="flex items-center gap-1.5 text-orange-500 font-semibold"><Plus size={13} strokeWidth={3} /> Add Category</span>
                  </SelectItem>
                </SelectContent>
              </Select>
            </div>
          ...
          {canEditWage ? (
            ...
            <div className="border border-zinc-800 bg-zinc-950/50 p-3 text-[11px] text-zinc-500" data-testid="wage-locked-note">
